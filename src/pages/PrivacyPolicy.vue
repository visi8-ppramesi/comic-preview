<template>
  <div>
    <div class="text-white p-5 my-5 md:max-w-5xl mx-auto text-center rounded-xl border border-slate-300 bg-gray-700/30">
      <h1>Privacy Policy for Visi8 Webcomic</h1>
      <p>
        At Visi8 Webcomic, accessible from
        https://visi8-webcomic.net/, one of our main priorities is the privacy
      ...
      useMeta(
          {
              ...
              meta: [
                  { property: 'og:title', content: 'Privacy Policy Page' },
                  { property: 'og:description', content: `privacy policy about webcomic website` },
                  { property: 'og:type', content: 'website' },
                  { property: 'og:url', content: 'https://visi8-webcomic.net/privacy-policy' },
              ]
          },
      )
  },
